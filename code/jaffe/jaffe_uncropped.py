...
rel_path = '/datasets/jaffe/jaffe3'
...
img_data_list = []
labels = []
labeldic={'ANGRY':0 ,'DISGUST':1,'FEAR':2,'HAPPY':3,'SAD':4,'SURPRISE':5}   #The labels and its value
for dataset in data_dir_list:
    ...
    for img in img_list:
        ...
        labels.append(labeldic[dataset.upper()])               #The label of each image is the name of its folder
...
img_data.shape
num_classes = 6   # jaffe                                            #Emotions labels\
...
model.fit(datagen.flow(x_train, y_train, batch_size=300), epochs=150, verbose=1)
print("rotation range:", datagen.rotation_range)

#---------------------------------------------
## Evaluating the model##
print('Jaffe uncropped')
print('RR 10°, HF, HT')
